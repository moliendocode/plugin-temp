...
void AOWSCharacter::UpdateCharacterData(const FCharacterData& InCharacterData, const TArray<FInventoryData>& InInventoryData, const FCharacterStats& InCharacterStats)
{
	if (GetLocalRole() == ROLE_Authority)
	{
