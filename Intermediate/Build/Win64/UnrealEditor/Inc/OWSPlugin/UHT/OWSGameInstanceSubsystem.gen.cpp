...
// Begin Class UOWSGameInstanceSubsystem Function GetAuthentication
struct Z_Construct_UFunction_UOWSGameInstanceSubsystem_GetAuthentication_Statics
{
	struct OWSGameInstanceSubsystem_eventGetAuthentication_Parms
	{
		UOWSAuthentication* ReturnValue;
	};
#if WITH_METADATA
	static constexpr UECodeGen_Private::FMetaDataPairParam Function_MetaDataParams[] = {
		{ "Category", "OWS|Authentication" },
...
const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UOWSGameInstanceSubsystem_GetAuthentication_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(OWSGameInstanceSubsystem_eventGetAuthentication_Parms, ReturnValue), Z_Construct_UClass_UOWSAuthentication_NoRegister, METADATA_PARAMS(0, nullptr) };
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_UOWSGameInstanceSubsystem_GetAuthentication_Statics::PropPointers[] = {
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UOWSGameInstanceSubsystem_GetAuthentication_Statics::NewProp_ReturnValue,
};
static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_UOWSGameInstanceSubsystem_GetAuthentication_Statics::PropPointers) < 2048);
const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UOWSGameInstanceSubsystem_GetAuthentication_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UOWSGameInstanceSubsystem, nullptr, "GetAuthentication", nullptr, nullptr, Z_Construct_UFunction_UOWSGameInstanceSubsystem_GetAuthentication_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UOWSGameInstanceSubsystem_GetAuthentication_Statics::PropPointers), sizeof(Z_Construct_UFunction_UOWSGameInstanceSubsystem_GetAuthentication_Statics::OWSGameInstanceSubsystem_eventGetAuthentication_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x54020401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UOWSGameInstanceSubsystem_GetAuthentication_Statics::Function_MetaDataParams), Z_Construct_UFunction_UOWSGameInstanceSubsystem_GetAuthentication_Statics::Function_MetaDataParams) };
static_assert(sizeof(Z_Construct_UFunction_UOWSGameInstanceSubsystem_GetAuthentication_Statics::OWSGameInstanceSubsystem_eventGetAuthentication_Parms) < MAX_uint16);
UFunction* Z_Construct_UFunction_UOWSGameInstanceSubsystem_GetAuthentication()
{
	static UFunction* ReturnFunction = nullptr;
	if (!ReturnFunction)
	{
		UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UFunction_UOWSGameInstanceSubsystem_GetAuthentication_Statics::FuncParams);
	}
	return ReturnFunction;
}
DEFINE_FUNCTION(UOWSGameInstanceSubsystem::execGetAuthentication)
{
	P_FINISH;
	P_NATIVE_BEGIN;
	*(UOWSAuthentication**)Z_Param__Result=P_THIS->GetAuthentication();
	P_NATIVE_END;
}
// End Class UOWSGameInstanceSubsystem Function GetAuthentication
...
// Begin Class UOWSGameInstanceSubsystem Function GetCustomerGUID
struct Z_Construct_UFunction_UOWSGameInstanceSubsystem_GetCustomerGUID_Statics
{
	struct OWSGameInstanceSubsystem_eventGetCustomerGUID_Parms
	{
		FString ReturnValue;
	};
#if WITH_METADATA
...
const UECodeGen_Private::FStrPropertyParams Z_Construct_UFunction_UOWSGameInstanceSubsystem_GetCustomerGUID_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(OWSGameInstanceSubsystem_eventGetCustomerGUID_Parms, ReturnValue), METADATA_PARAMS(0, nullptr) };
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_UOWSGameInstanceSubsystem_GetCustomerGUID_Statics::PropPointers[] = {
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UOWSGameInstanceSubsystem_GetCustomerGUID_Statics::NewProp_ReturnValue,
};
static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_UOWSGameInstanceSubsystem_GetCustomerGUID_Statics::PropPointers) < 2048);
const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UOWSGameInstanceSubsystem_GetCustomerGUID_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UOWSGameInstanceSubsystem, nullptr, "GetCustomerGUID", nullptr, nullptr, Z_Construct_UFunction_UOWSGameInstanceSubsystem_GetCustomerGUID_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UOWSGameInstanceSubsystem_GetCustomerGUID_Statics::PropPointers), sizeof(Z_Construct_UFunction_UOWSGameInstanceSubsystem_GetCustomerGUID_Statics::OWSGameInstanceSubsystem_eventGetCustomerGUID_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x54020401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UOWSGameInstanceSubsystem_GetCustomerGUID_Statics::Function_MetaDataParams), Z_Construct_UFunction_UOWSGameInstanceSubsystem_GetCustomerGUID_Statics::Function_MetaDataParams) };
static_assert(sizeof(Z_Construct_UFunction_UOWSGameInstanceSubsystem_GetCustomerGUID_Statics::OWSGameInstanceSubsystem_eventGetCustomerGUID_Parms) < MAX_uint16);
UFunction* Z_Construct_UFunction_UOWSGameInstanceSubsystem_GetCustomerGUID()
{
	static UFunction* ReturnFunction = nullptr;
	if (!ReturnFunction)
	{
		UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UFunction_UOWSGameInstanceSubsystem_GetCustomerGUID_Statics::FuncParams);
	}
	return ReturnFunction;
}
DEFINE_FUNCTION(UOWSGameInstanceSubsystem::execGetCustomerGUID)
{
	P_FINISH;
	P_NATIVE_BEGIN;
	*(FString*)Z_Param__Result=P_THIS->GetCustomerGUID();
	P_NATIVE_END;
}
// End Class UOWSGameInstanceSubsystem Function GetCustomerGUID
...
void UOWSGameInstanceSubsystem::StaticRegisterNativesUOWSGameInstanceSubsystem()
{
	...
	static const FNameNativePtrPair Funcs[] = {
		...
		{ "GetAuthentication", &UOWSGameInstanceSubsystem::execGetAuthentication },
		{ "GetAuthToken", &UOWSGameInstanceSubsystem::execGetAuthToken },
		{ "GetCustomerGUID", &UOWSGameInstanceSubsystem::execGetCustomerGUID },
...
struct Z_Construct_UClass_UOWSGameInstanceSubsystem_Statics
{
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_Authentication_MetaData[] = {
#if !UE_BUILD_SHIPPING
		{ "Comment", "// Ahora usamos un puntero UPROPERTY para que el GC lo administre\n" },
#endif
		{ "ModuleRelativePath", "Public/OWSGameInstanceSubsystem.h" },
#if !UE_BUILD_SHIPPING
		{ "ToolTip", "Ahora usamos un puntero UPROPERTY para que el GC lo administre" },
#endif
	};
#endif // WITH_METADATA
	...
	static const UECodeGen_Private::FObjectPropertyParams NewProp_Authentication;
	static const UECodeGen_Private::FPropertyParamsBase* const PropPointers[];
	static UObject* (*const DependentSingletons[])();
	static constexpr FClassFunctionLinkInfo FuncInfo[] = {
		{ &Z_Construct_UFunction_UOWSGameInstanceSubsystem_ClearAuthToken, "ClearAuthToken" }, // 3642415364
		{ &Z_Construct_UFunction_UOWSGameInstanceSubsystem_GetAuthentication, "GetAuthentication" }, // 1801726924
		{ &Z_Construct_UFunction_UOWSGameInstanceSubsystem_GetAuthToken, "GetAuthToken" }, // 828692656
		{ &Z_Construct_UFunction_UOWSGameInstanceSubsystem_GetCustomerGUID, "GetCustomerGUID" }, // 13074151
...
const UECodeGen_Private::FObjectPropertyParams Z_Construct_UClass_UOWSGameInstanceSubsystem_Statics::NewProp_Authentication = { "Authentication", nullptr, (EPropertyFlags)0x0040000000000000, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UOWSGameInstanceSubsystem, Authentication), Z_Construct_UClass_UOWSAuthentication_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_Authentication_MetaData), NewProp_Authentication_MetaData) };
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_UOWSGameInstanceSubsystem_Statics::PropPointers[] = {
	...
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UOWSGameInstanceSubsystem_Statics::NewProp_Authentication,
};
...
struct Z_CompiledInDeferFile_FID_Unreal_Projects_UnrealFruits_Plugins_OWSPlugin_Source_OWSPlugin_Public_OWSGameInstanceSubsystem_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UOWSGameInstanceSubsystem, UOWSGameInstanceSubsystem::StaticClass, TEXT("UOWSGameInstanceSubsystem"), &Z_Registration_Info_UClass_UOWSGameInstanceSubsystem, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UOWSGameInstanceSubsystem), 2549382704U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Unreal_Projects_UnrealFruits_Plugins_OWSPlugin_Source_OWSPlugin_Public_OWSGameInstanceSubsystem_h_3227007319(TEXT("/Script/OWSPlugin"),
